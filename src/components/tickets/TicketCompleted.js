...
import { startRemoveTicket, startUpdateTicket } from '../../actions/ticket'
...
function TicketCompleted(props)
{
    ...
    const handleChange = (ticket) =>
    {
        ...
        props.dispatch(startUpdateTicket(formData, ticket._id))
                    ...
                    props.tickets.map((ticket)=>
                    {
                        return(
                            <tr key = {ticket._id}>
                                ...
                                <td>{
                                        !_.isEmpty(ticket.employees) && empList(ticket.employees)
                                    }</td>
